...
package mietwagen.petriks_updatesite_0_1;
...
/**
 * Job: Petriks_UpdateSite Purpose: <br>
 * Description:  <br>
 * @author andreh.alhannon@gmail.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Petriks_UpdateSite implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Petriks_UpdateSite";
	private final String projectName = "MIETWAGEN";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Petriks_UpdateSite.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Petriks_UpdateSite.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_MIETWAGEN_Petriks_UpdateSite = new byte[0];
    static byte[] commonByteArray_MIETWAGEN_Petriks_UpdateSite = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MIETWAGEN_Petriks_UpdateSite.length) {
				if(length < 1024 && commonByteArray_MIETWAGEN_Petriks_UpdateSite.length == 0) {
   					commonByteArray_MIETWAGEN_Petriks_UpdateSite = new byte[1024];
				} else {
   					commonByteArray_MIETWAGEN_Petriks_UpdateSite = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MIETWAGEN_Petriks_UpdateSite, 0, length);
			strReturn = new String(commonByteArray_MIETWAGEN_Petriks_UpdateSite, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MIETWAGEN_Petriks_UpdateSite, 0, length);
			strReturn = new String(commonByteArray_MIETWAGEN_Petriks_UpdateSite, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MIETWAGEN_Petriks_UpdateSite) {
...
public void tREST_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"Body","ERROR_CODE",});        
 ...
 */
	...
	String endpoint_tREST_2 = "https://dev-petriks-market.pantheonsite.io/";
...
globalMap.put("tREST_2_ERROR_MESSAGE",ue.getMessage());
	...
	// for output
				...
				if(errorResponse_tREST_2!=null){
					row3.ERROR_CODE = errorResponse_tREST_2.getStatus();
					if(row3.ERROR_CODE!=204){
					    row3.Body = errorResponse_tREST_2.getEntity(String.class);
					}
				}else{
					row3.Body = restResponse_tREST_2;
				}
...
///////////////////////		
	    		...
	    		if(row3.ERROR_CODE != null) { //              
                 row_tLogRow_2[1]=    						    
				                String.valueOf(row3.ERROR_CODE)			
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final Petriks_UpdateSite Petriks_UpdateSiteClass = new Petriks_UpdateSite();

        int exitCode = Petriks_UpdateSiteClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Petriks_UpdateSite.class.getClassLoader().getResourceAsStream("mietwagen/petriks_updatesite_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Petriks_UpdateSite.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
try {
errorCode = null;tREST_2Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
}catch (TalendException e_tREST_2) {
globalMap.put("tREST_2_SUBPROCESS_STATE", -1);

e_tREST_2.printStackTrace();
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Petriks_UpdateSite");
        }
...
/************************************************************************************************
 *     44927 characters generated by Talend Open Studio for Big Data 
 *     on the February 19, 2023 at 4:05:07 PM CET
 ************************************************************************************************/